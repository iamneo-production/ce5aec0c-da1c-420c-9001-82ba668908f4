  ...
  useEffect(() => {
    ...
    const fetchAdmission = async () => {
      ...
      if (foundAdmission) {
        ...
        try {
          const response3 = await axios.get(`https://8080-eabffbfafccbfebbdadbedabeaeaadbdbabf.project.examly.io/admissions/${admissionIds}`);
          ...
          if (foundenrollment) {
            ...
            const response2 = await axios.get(`https://8080-eabffbfafccbfebbdadbedabeaeaadbdbabf.project.examly.io/admin/enrollments/${enrollmentId}`);
