...
const CourseDetails = () => {
  ...
  const handleEnrollNow = async () => {
    ...
    console.log(foundAdmission);
        ...
        navigate('/ApplicationForm');
          ...
          const response3 = await axios.get(`https://8080-eabffbfafccbfebbdadbedabbffaabaebdcec.project.examly.io/admissions/${admissionId}`);
          ...
          {
            const response1 = await axios.get('https://8080-eabffbfafccbfebbdadbedabbffaabaebdcec.project.examly.io/admin/enrollments');
  ...
  const enrollCourse = async () => {
    try {
      ...
      const response = await axios.post('https://8080-eabffbfafccbfebbdadbedabbffaabaebdcec.project.examly.io/admin/enrollments', enrollmentData);
