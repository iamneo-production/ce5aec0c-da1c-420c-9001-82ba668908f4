...
const CourseDetails = () => {
  ...
  const handleEnrollNow = async () => {
      ...
      try {
        const response = await axios.get('https://8080-deeefebadfbfcffebbdadbedabbffaabaebdcec.project.examly.io/admissions');
    ...
    console.log(foundAdmission);
        ...
        navigate('/ApplicationForm');
          ...
          const response3 = await axios.get(`https://8080-deeefebadfbfcffebbdadbedabbffaabaebdcec.project.examly.io/admissions/${admissionId}`);
          ...
          {
            const response1 = await axios.get('https://8080-deeefebadfbfcffebbdadbedabbffaabaebdcec.project.examly.io/admin/enrollments');
  ...
  const enrollCourse = async () => {
    try {
      ...
      const response = await axios.post('https://8080-deeefebadfbfcffebbdadbedabbffaabaebdcec.project.examly.io/admin/enrollments', enrollmentData);
